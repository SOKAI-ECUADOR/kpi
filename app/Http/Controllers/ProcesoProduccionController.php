...
class ProcesoProduccionController extends Controller
{
    ...
    public function verAsiento(Request $request,$id){
        ...
        $query2="SELECT 
                ...
                (select id_proyecto from proyecto where id_proyecto={$prod[0]->id_proyecto} limit 1) as id_proyecto,
                (select descripcion from proyecto where id_proyecto={$prod[0]->id_proyecto} limit 1) as descripcion,
                null as debe,
    ...
    public function eliminarproceso_produccion(Request $request)
    {
        ...
        $produccion=DB::select("SELECT * from proceso_produccion where id_proceso_produccion={$id_proceso}");
