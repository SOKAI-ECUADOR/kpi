...
class PDF_MC_Table_HF extends FPDF
{
    public $widths;
    public $aligns;
    public $logo;
    ...
    public function __construct($orientation='P', $unit='mm', $size='A4', $logo, $direccion, $telefono, $ciudad) {
    ...
    {
        // Logo
        $this->Image($this->logo,85,8,40);
        // Salto de línea
        $this->Ln(20);
        $this->SetFillColor(204, 204, 204);
        $this->SetXY(15, $this->getY()+1);
        $this->Cell(181,0.5,'',0,0,'L',1);
        $this->SetFillColor(255, 122, 0);
        $this->SetXY(50, $this->getY()-1);
        $this->Cell(110,2,'',0,0,'L',1);
    }
    ...
    function Footer()
    {
        ...
        $this->SetY(-20);
        // Arial italic 8
        $this->SetTextColor(255, 122, 0);
        $this->SetFont('Helvetica','I',8);
        // Número de página
        $this->Cell(0,5,utf8_decode($this->direccion),0,1,'C');
        $this->Cell(0,5,utf8_decode('Tel '.$this->telefono),0,1,'C');
        $this->Cell(0,5,utf8_decode($this->ciudad.' - Ecuador'),0,1,'C');
    }
