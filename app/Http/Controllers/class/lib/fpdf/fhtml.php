<?php
//Based on HTML2PDF by Clément Lavoillotte M
...
function WriteHTML($html)
{
    ...
    foreach($a as $i=>$e)
    {
        if($i%2==0)
        {
            ...
            elseif($this->tdbegin) {
                if(trim($e)!='' && $e!="&nbsp;") {
                    $this->Cell($this->tdwidth,$this->tdheight,utf8_decode($e),$this->tableborder,'',$this->tdalign,$this->tdbgcolor);
                }
                elseif($e=="&nbsp;") {
