    ...
    @if($factura->id_empresa==59)
        <div style="margin-top: 60px; align-items: center">
            ...
            <div style="width: 43%; display: inline-block;" class="bordeado">
                ...
                <div style="width:100%"><span class="titulo1-1">{{$empresa->ruc_empresa}}</span></div> -->
                <div style="width:100%"><span class="titulo1">NOTA VENTA N°:</span></div>
                <div style="width:100%" class="mb-1"><span class="titulo2">N° {{substr($clave_acceso,35,4)}}</span></div>
                ...
                @if($empresa->tipo_emision==1)
                    <div style="width:100%" class="mb-1"><span class="titulo1">EMISIÓN:</span> </div>
            ...
            <div style="width: 100%;margin-top: 10px;" class="bordeado1">
                <div style="padding:5px">
                    <div style="width:100%"><span class="titulo3 bold">Nombres y Apellidos:</span> <span class="texto">{{$cliente->nombre}}</span></div>
                    <div style="width:100%"><span class="titulo3 bold" style="width: 48%; display: inline-block">CI: <span class="texto nobold">{{$cliente->identificacion}}</span></span> <span class="titulo3 bold" style="text-align: right">Correo: <span class="texto nobold">{{$cliente->email}}</span></span></div>
                ...
                <tbody>
                    ...
                    @foreach($detalles as $detalle)
                        <tr>
                            ...
                            @endif
                            @if($detalle->id_iva==2)
                            <td class="text-center">{{number_format(number_format($detalle->precio,2,".","")+(number_format($detalle->precio,2,".","")*0.12),2,".",",")}}</td>
                            @else
                            ...
                            @if($detalle->id_iva==2)
                            <td class="text-center">${{number_format($detalle->total+($detalle->total*0.12),2,".",",")}}</td>
                            @else
                ...
                <tbody>
                    ...
                    @foreach($detalles as $detalle)
                        <tr>
                            ...
                            <td>{{$detalle->nombre}}</td>
                            @if($empresa->id_empresa==71)
                                <td class="text-center">{{number_format($detalle->precio,4,".",",")}}</td>
                            @else
                                <td class="text-center">{{number_format($detalle->precio,2,".",",")}}</td>
                            @endif
                            <td class="text-center">
        ...
        <div style="margin-bottom:30px;">
            <div style="float: left; width: 60%;">
                <div style="position:absolute">
                    ...
                    @elseif($empresa->id_empresa==7 && $empresa->nombre_empresa=='TECHCOMP SOLUTIONS')
                        <div style="border: 1px solid #000;margin-top:15px;">
                            <div style="width:100%;margin-bottom:0px;border-bottom:1px solid #000;padding: 2px 5px;">
                            <span class="titulo3 nobold" style="display:block;text-align:left;font-size:14px;">REALIZE SUS DEPOSITOS Y TRANSFERENCIAS A:</span>
                                <span class="bold" style="font-size:16px;display:block;text-align:LEFT;font-weight:600;">
                            ...
                            <div style="width:100%;margin-top:15px">
                                ...
                                <div style="width: 45%;display: inline-block;text-align:LEFT">
                                    <div style="display:block;font-size:16px;">BANCO INTERNACIONAL</div>
                                    <div style="display:block;font-size:16px;">CUENTA CORRIENTE - <b>N° 661419</b></div>
                                    <div style="display:block;font-size:16px;">RUC: 1792684706001</div>
                                    <div style="display:block;font-size:16px;">ADMINISTRACION@TECHCOMPSOLUTIONS.COM</div>
                                </div>
                            </div>
