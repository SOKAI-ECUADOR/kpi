...
<html lang="en">
    ...
    @if($factura->id_empresa==59)
        <div style="margin-top: 60px; align-items: center">
            ...
            <div style="width: 100%;margin-top: 10px;" class="bordeado1">
                <div style="padding:5px">
                    ...
                    <div style="width:100%"><span class="titulo3 bold">Dirección:</span> <span class="texto">{{$cliente->direccion_prov}}</span></div>
                    <div style="width:100%"><span class="titulo3 bold" style="width: 48%; display: inline-block;">Teléfonos: <span class="texto nobold">{{$cliente->telefono_prov}}</span></span>
                </div>
            </div>
        </div>
        ...
        <div style="margin-bottom:30px;">
                    ...
                    @foreach($pagos as $pago)
                        <div style="border: 1px solid #000;margin-bottom:5px;">
                            ...
                            <div style="width:100%;margin-top:5px">
                                ...
                                @else
                                <span class="titulo3 bold" style="width: 23%;display: inline-block;text-align:center">Tiempo <br><span class="nobold" style="font-size:8px">1</span></span>
                                @endif
            ...
            <div style="margin-left: 65%; width: 35%;margin-top:10px">
                <div style="width: 100%; display: inline-block;border:1px solid #000;margin-top:1px">
    ...
    <div style="margin-top: 60px; align-items: center">
            ...
            <div style="width: 43%; display: inline-block;" class="bordeado">
                ...
                <div style="width:100%"><span class="titulo1">LIQUIDACION COMPRA N°:</span></div>
                <div style="width:100%" class="mb-1"><span class="titulo2">N° {{substr($clave_acceso_2,24,3)}}-{{substr($clave_acceso_2,27,3)}}-{{substr($clave_acceso_2,30,9)}}</span></div>
                <div style="width:100%" class="mb-1"><span class="titulo1">NÚMERO DE AUTORIZACIÓN:</span></div>
                <div style="width:100%" class="mb-1"><span class="titulo2">{{$clave_acceso_2}}</span></div>
                <div style="width:100%" class="mb-1"><span class="titulo1">FECHA Y HORA DE AUTORIZACION:</span></div>
                ...
                <div style="width:100%" class="mb-1"><span class="titulo1">CLAVE DE ACCESO</span> </div>
                <div style="width:100%;display:block">
                    <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($clave_acceso_2, 'C128',3,33)}}" style="width:100%;height:65px">
                    <span style="display:block;font-size:10px;text-align:center">{{$clave_acceso_2}}</span>
                </div>
            </div>
            @if($empresa->nombre_empresa!=='C.E. FUEGOS GROUP' && $empresa->nombre_empresa!=='C.E.FUEGOS SYSTEM' && $empresa->nombre_empresa!=='C.E. FUEGOS')
                <div style="width: 100%;margin-top: -50px;" class="bordeado1">
                    <div style="padding:5px">
                        <div style="width:100%"><span class="titulo3 bold">Razón Social / Nombres y Apellidos:</span> <span class="texto">{{$cliente->nombre_proveedor}}</span></div>
