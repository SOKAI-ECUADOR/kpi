      ...
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <div class="header-sidebar flex items-end justify-between mb-3" slot="header" style="position: relative;height: 65px;">
          ...
          <router-link tag="div" class="vx-logo cursor-pointer flex items-center" to="/">
            <img v-if="tema=='light'" src="/images/logo/logo-sokai.png" alt="logo" style="position: absolute;top: 3px;width: 14rem;left: 8px;margin-top: 7px;margin-left: 7px;">
            <img v-else src="/images/logo/logo-sokai-sitema.png" alt="logo" style="position: absolute;top: 3px;width: 14rem;left: 8px;margin-top: 7px;margin-left: 7px;">
