                ...
                <div class="vx-row" id="el">
                    ...
                    <div class="vx-col sm:w-3/12 w-full mb-6">
                        <vs-select
                            ...
                            vs-multiple
                            autocomplete
                            :disabled="cabeceraAsientoContable.automatico === 1 || cabeceraAsientoContable.comprobante>3"
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6" v-if="!tipo_identificacion" hidden>
                        ...
                        <vs-input class="selectExample w-full" label="Identificacion:" vs-multiple autocomplete v-else  maxlength="15" v-model="cabeceraAsientoContable.ruc_ci" />
                ...
                <div class="vx-row">
                    ...
                    <div class="vx-col sm:w-2/12 w-full mb-6">
                        ...
                        <vs-input
                            ...
                            maxlength="15"
                            :disabled="
                                (listaAsientoscontables[index].detalle.haber &&
                                    listaAsientoscontables[index].detalle.haber.length > 0) ||
                                (listaAsientoscontables[index].detalle.debe === '' &&
                                    listaAsientoscontables[index].detalle.haber !== '')"
                            @keypress="solonumeros($event)"
                    ...
                    <div class="vx-col sm:w-2/12 w-full mb-6">
                        ...
                        <vs-input
                            ...
                            :disabled="
                                (listaAsientoscontables[index].detalle.debe &&
                                    listaAsientoscontables[index].detalle.debe.length > 0) ||
                                (listaAsientoscontables[index].detalle.haber === '' &&
                                    listaAsientoscontables[index].detalle.debe !== '')"
                            @keypress="solonumeros($event)"
                            @keyup="cuadreAsientoContable(index)"
...
export default {
    ...
    computed: {
        ...
        codigoComprobante() {
            ...
            if(this.cabeceraAsientoContable.comprobante<4){
                if (
                    ...
                    console.log(this.comprobanteTemporal);
        ...
        cambioFormaPago(){
            ...
            for (const asiento of this.listaAsientoscontables) {
                if(asiento.detalle.id_forma_pago){
                    asiento.detalle.id_pago_sri=asiento.detalle.id_forma_pago;
                }
            }
        }
    },
    ...
    methods: {
        ...
        cambioidFormaPago(){
            this.listaAsientoscontables[this.indextipoarreglo].detalle.id_pago_sri=this.listaAsientoscontables[this.indextipoarreglo].detalle.id_forma_pago;
        },
        obtenerComprobantes() {
            const url =
        ...
        handleSelected(tr) {
            ...
            if (tr.codcta[tr.codcta.length - 1] === ".") {
                ...
                //this.listarfomaspagos(tr.id_plan_cuentas);
                this.listaAsientoscontables[
                    this.idProyectoTemporal
            ...
            if (parseInt(tr.bansel) == 1 || parseInt(tr.bansel) == 2) {
                ...
                this.listaAsientoscontables[
                    this.idProyectoTemporal
                ].detalle.fecha = this.cabeceraAsientoContable.fecha;
                this.listaAsientoscontables[
                    this.idProyectoTemporal
                ].detalle.typeCount = 1;
            } else {
                    ...
                    this.indextipoarreglo=0;
                        this.listaAsientoscontables.push({
                            detalle: {
                                ...
                                id_forma_pago:asiento.id_forma_pagos,
