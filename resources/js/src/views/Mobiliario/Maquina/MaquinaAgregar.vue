<template>
    <div class="vx-row">
        <div class="vx-col w-full mb-base">
            <vx-card title="Agregar Maquinaria Equipo">
                <div class="vx-row">
...
export default {
    ...
    methods: {
        ...
        buscardatos() {
            var url =
                "/api/buscarmaquinamobiliario/" +
                this.$route.params.id;
            axios.get(url).then(res => {
                var respuesta = res.data.recupera[0];
                this.tipo_activo=respuesta.id_tipo_activo;
                this.codigo_identificacion=respuesta.codigo_identificacion_maquina;
                this.codigo_anterior=respuesta.codigo_anterior_maquina;
                this.descripcion_anterior=respuesta.descripcion_anterior_maquina;
                this.descripcion_actualizada=respuesta.descripcion_actualizada_maquina;
                this.marca=respuesta.id_marca;
                this.modelo=respuesta.id_modelo;
                this.serie=respuesta.serie_maquina;
                ...
                this.fechacompra=respuesta.fechacompra_maquina;
                this.costoadquisicion=respuesta.costoadquisicion_maquina;
                ...
                this.cuentacontable=respuesta.cuentacontable_maquina;
                this.observaciones=respuesta.observaciones_maquina;
                this.id_maquina=respuesta.id_maquina;
            });
        },
        guardar() {
            /*if (this.validar()) {
            ...
            axios
                .post("/api/guardarmaquinamobiliario", {
                ...
                .then(res => {
                        ...
                        this.$router.push("/mobiliario/maquina");
        ...
        editar() {
            ...
            axios
                .post("/api/editarmaquinamobiliario", {
                    tipo_activo: this.tipo_activo,
                    codigo_identificacion: this.codigo_identificacion,
                    codigo_anterior: this.codigo_anterior,
                    descripcion_anterior: this.descripcion_anterior,
