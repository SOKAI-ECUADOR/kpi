        ...
        <vx-card>
                ...
                >
                    ...
                    <div class="dropdown-button-container">
                        <vs-button
                            class="btnx"
                            type="filled"
                            to="/mobiliario/vehiculo/agregar"
                            >Agregar</vs-button
                        >
                        <vs-dropdown>
                            <vs-button
            ...
            <vs-table stripe max-items=25 pagination :data="contenido">
                ...
                <template slot-scope="{ data }">
                    <vs-tr
                        :key="datos.id_vehiculo"
                        v-for="datos in data"
                        class="text-center"
                    >
                        <vs-td v-if="datos.codigo_identificacion_vehiculo">{{
                            datos.codigo_identificacion_vehiculo
                        }}</vs-td>
                        <vs-td v-else>-</vs-td>
                        <vs-td v-if="datos.descripcion_vehiculo">{{
                            datos.descripcion_vehiculo
                        }}</vs-td>
                        <vs-td v-else>-</vs-td>
                        <vs-td v-if="datos.codigo_anterior_vehiculo">{{
                            datos.codigo_anterior_vehiculo
                        }}</vs-td>
                        <vs-td v-else>-</vs-td>
                        ...
                        <vs-td class="whitespace-no-wrap">
                            <feather-icon
                                ...
                                @click.stop="editar(datos.id_vehiculo)"
                            />
                            <feather-icon
                                ...
                                @click.stop="eliminarVehiculo(datos.id_vehiculo)"
                            />
                        </vs-td>
                    </vs-tr>
                </template>
...
export default {
    ...
    methods: {
        ...
        editar(id) {
            this.$router.push(`/mobiliario/vehiculo/${id}/editar`);
        },
        eliminarVehiculo(id) {
            this.$vs.dialog({
                type: "confirm",
