        ...
        <vx-card>
            ...
            <vs-table stripe max-items=25 pagination :data="contenido">
                ...
                <template slot-scope="{ data }">
                    <vs-tr
                        :key="datos.id_enseres"
                        v-for="datos in data"
                        class="text-center"
                    >
                        <vs-td v-if="datos.codigo_identificacion_enseres">{{
                            datos.codigo_identificacion_enseres
                        }}</vs-td>
                        <vs-td v-else>-</vs-td>
                        <vs-td v-if="datos.descripcion_actualizada_enseres">{{
                            datos.descripcion_actualizada_enseres
                        }}</vs-td>
                        <vs-td v-else>-</vs-td>
                        <vs-td v-if="datos.codigo_anterior_enseres">{{
                            datos.codigo_anterior_enseres
                        }}</vs-td>
                        <vs-td v-else>-</vs-td>
                        ...
                        <vs-td class="whitespace-no-wrap">
                            <feather-icon
                                ...
                                @click.stop="editar(datos.id_enseres)"
                            />
                            <feather-icon
                                ...
                                @click.stop="eliminarVehiculo(datos.id_enseres)"
                            />
                        </vs-td>
                    </vs-tr>
                </template>
...
export default {
    ...
    methods: {
        ...
        editar(id) {
            this.$router.push(`/mobiliario/enseres/${id}/editar`);
        },
        eliminarVehiculo(id) {
            this.$vs.dialog({
                type: "confirm",
        ...
        acceptAlert(id) {
            axios.delete("/api/eliminarenseresmobiliario/" + id);
            this.$vs.notify({
                color: "danger",
                title: "Enseres Eliminado  ",
                text: "El enseres selecionado fue eliminado con exito"
            });
