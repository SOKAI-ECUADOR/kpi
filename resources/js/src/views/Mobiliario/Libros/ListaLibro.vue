        ...
        <vx-card>
            ...
            <vs-table stripe max-items=25 pagination :data="contenido">
                <template slot="thead">
                    ...
                    <vs-th class="text-center">Editorial</vs-th>
                ...
                <template slot-scope="{ data }">
                    <vs-tr
                        ...
                        class="text-center"
                    >
                        <vs-td v-if="datos.codigo_identificacion_libro">{{
                            datos.codigo_identificacion_libro
                        }}</vs-td>
                        <vs-td v-else>-</vs-td>
                        <vs-td v-if="datos.titulo_actualizado_libro">{{
                            datos.titulo_actualizado_libro
                        }}</vs-td>
                        <vs-td v-else>-</vs-td>
                        <vs-td v-if="datos.editorial_libro">{{
                            datos.editorial_libro
                        }}</vs-td>
                        <vs-td v-else>-</vs-td>
                        <vs-td v-if="datos.codigo_anterior_libro">{{
                            datos.codigo_anterior_libro
                        }}</vs-td>
                        <vs-td v-else>-</vs-td>
                        ...
                        <vs-td class="whitespace-no-wrap">
                            <feather-icon
                                ...
                                @click.stop="editar(datos.id_libro)"
                            />
                            <feather-icon
                                ...
                                @click.stop="eliminarVehiculo(datos.id_libro)"
                            />
                        </vs-td>
                    </vs-tr>
                </template>
...
export default {
    ...
    methods: {
        ...
        editar(id) {
            this.$router.push(`/mobiliario/libro/${id}/editar`);
        },
        eliminarVehiculo(id) {
            this.$vs.dialog({
                type: "confirm",
        ...
        acceptAlert(id) {
            axios.delete("/api/eliminarlibromobiliario/" + id);
            this.$vs.notify({
                color: "danger",
                title: "Libro Eliminado  ",
                text: "El libro selecionado fue eliminado con exito"
            });
