            ...
            <vx-card>
                ...
                <div class="vx-row">
                    ...
                    <div class="vx-col sm:w-1/4 w-full mb-6">
                        <vs-input
                            ...
                            label="Ruc"
                            v-model="ruc"
                            onkeypress="return enteros(event,this);"
                            @blur="validarruc"
                            maxlength="13"
                            disabled
                        />
                    ...
                    <div class="vx-col sm:w-1/2 w-full mb-6">
                        ...
                        <div v-show="error" v-if="!nombre_comercial">
                            <span
                                class="text-danger"
                                v-for="(err, index) in errornombre_comercial"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-2/5 w-full mb-6">
                        ...
                        <div v-show="error" v-if="!razon_social">
                            <span
                                class="text-danger"
                                v-for="(err, index) in errorrazon_social"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/5 w-full mb-6">
                        ...
                        <vs-chips
                            ...
                            placeholder="Agregue los telefonos"
                            v-model="telefono"
                            icon-pack="feather"
                        ...
                        <span
                            ...
                            v-show="errors.has('telef')"
                            >Este campo solo lleva numeros</span
                        >
                    </div>
                    <div class="vx-col sm:w-2/5 w-full mb-6">
                        <vs-input
                        ...
                        <div v-show="error" v-if="!direccion">
                            <span
                                class="text-danger"
                                v-for="(err, index) in errordireccion"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        ...
                        <div v-show="error" v-if="!provincia">
                            <span
                                class="text-danger"
                                v-for="(err, index) in errorprovincia"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        ...
                        <div v-show="error" v-if="!ciudad">
                            <span
                                class="text-danger"
                                v-for="(err, index) in errorciudad"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        <vs-input
                            ...
                            name="rucConta"
                            label="Ruc Contador"
                            v-model="ruc_contador"
                            onkeypress="return enteros(event,this);"
                            @blur="validarruccontador"
                            maxlength="13"
                        />
                        <div v-show="error">
                            <span
                                class="text-danger"
                                v-for="(err, index) in errorruc_contador"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/2 w-full mb-6">
                        <vs-input
                            ...
                            v-model="nomb_representante"
                        />
                    </div>
                    <div
                        class="vx-col sm:w-1/3 w-full mb-6"
                        :class="{ 'sm:w-1/4': tipo_identidicacion }"
                    >
                        <vs-select
                            placeholder="Tipo"
                            class="selectExample w-full"
                        ...
                        >
                            <vs-select-item
                                ...
                                :text="item.text"
                                v-for="(item,
                                index) in array_tipo_identificacion"
                            />
                        </vs-select>
                        <div v-show="error" v-if="!tipo_identidicacion">
                            <span
                                class="text-danger"
                                v-for="(err,
                                index) in error_tipo_identidicacion"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div
                        class="vx-col sm:w-1/3 w-full mb-6"
                        :class="{ 'sm:w-1/4': tipo_identidicacion }"
                        v-if="tipo_identidicacion"
                    >
                        <vs-input
                            class="w-full"
                            label="Identificacion Representante"
                            v-model="identificacion_representante"
                            v-if="tipo_identidicacion == 'Cedula'"
                            onkeypress="return enteros(event,this);"
                            @blur="validarrepresentante"
                            maxlength="10"
                        />
                        <vs-input
                            class="w-full"
                            label="Identificacion Representante"
                            v-model="identificacion_representante"
                            v-else-if="tipo_identidicacion == 'Ruc'"
                            onkeypress="return enteros(event,this);"
                            @blur="validarrucrepresentante"
                            maxlength="13"
                        />
                        <vs-input
                            class="w-full"
                        ...
                        <div v-show="error">
                            <span
                                class="text-danger"
                                v-for="(err,
                                index) in erroridentificacion_representante"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        ...
                        <flat-pickr
                            ...
                            v-model="fecha_duracion"
                            disabled
                        />
                    </div>
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        <label class="vs-input--label"
                            >Obligado llevar contabilidad</label
                        >
                        <vs-checkbox
                            icon-pack="feather"
                            icon="icon-check"
                            class="mt-2"
                            v-model="contabilidad"
                            disabled
                        >
                    ...
                    <div
                        class="vx-col sm:w-1/3 w-full mb-6"
                        :class="{ 'sm:w-1/4': balance == 'Si' }"
                    >
                        <label class="vs-input--label"
                            >Fecha de último cierre</label
                        >
                        <flat-pickr
                            :config="configdateTimePicker"
                            class="w-full"
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        <vs-input
                            ...
                            v-model="codigo_entidad"
                            disabled
                        />
                        <span
                            class="text-danger text-sm"
                            v-show="errors.has('codEntidad')"
                            >Este campo solo lleva numeros</span
                        >
                    </div>
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                ...
                <div class="vx-row chtm" v-if="contribuyente == 1">
                    <vs-divider border-style="solid" color="dark"
                        >Contribuyente especial</vs-divider
                    >
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        <vs-input
                            ...
                            class="w-full"
                            label="No. Resolucion"
                            v-model="numero_resolucion"
                        />
                        <span
                            class="text-danger text-sm"
                            v-show="errors.has('noResolucion')"
                            >Este campo solo lleva numeros</span
                        >
                    </div>
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        <vs-input
                            ...
                            v-model="numero_contribuyente"
                        />
                    </div>
                </div>

                <vs-divider border-style="solid" color="dark"
                    >Datos Opcionales</vs-divider
                >
                <div class="vx-row">
                    <div class="vx-col sm:w-1/2 w-full mb-6">
                        <vs-input
                    ...
                    <div class="vx-col sm:w-1/2 w-full mb-6">
                        <vs-input
                            type="text"
                            class="w-full"
                            label="Segundo campo de factura"
                            v-model="segundoc"
                        />
                    </div>
                </div>
                ...
                <vs-divider border-style="solid" color="dark"
                    >Cuentas de la empresa</vs-divider
                >
                <div class="vx-row">
                    <div class="vx-col sm:w-1/4 w-full mb-6">
                ...
                <div class="vx-row">
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        <vs-select
                            placeholder="Selecciona la Leyenda"
                            class="selectExample w-full"
                            label="Leyenda"
                            vs-multiple
                            autocomplete
                        ...
                        >
                            ...
                            <vs-select-item
                                value="AGENTE DE RETENCIÓN RESOLUCION NAC No DNCRASC20-00000001"
                                text="AGENTE DE RETENCIÓN RESOLUCION NAC No DNCRASC20-00000001"
                            />
                            <vs-select-item
                                value="CONTRIBUYENTE REGIMEN MICROEMPRESA"
                                text="CONTRIBUYENTE REGIMEN MICROEMPRESA"
                            />
                            <vs-select-item
                                value="2"
                                text="AGENTE DE RETENCIÓN RESOLUCION NAC No DNCRASC20-00000001 Y REGIMEN MICROEMPRESA"
                            />
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        <vs-input
                            ...
                            v-model="email_facturacion"
                        />
                    </div>
                </div>
                <vs-divider border-style="solid" color="dark"
                    >Punto de emisión</vs-divider
                >
                <div class="vx-row">
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        <vs-input
                        ...
                        <div v-show="error">
                            <span
                                class="text-danger"
                                v-for="(err, index) in errorsecuencial_factura"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        <vs-input
                            class="w-full"
                            name="text"
                            label="Secuencial de Nota de crédito"
                        ...
                        <div v-show="error">
                            <span
                                class="text-danger"
                                v-for="(err,
                                index) in errorsecuencial_nota_credito"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        <vs-input
                            class="w-full"
                            name="text"
                            label="Secuencial de Nota de débito"
                        ...
                        <div v-show="error">
                            <span
                                class="text-danger"
                                v-for="(err,
                                index) in errorsecuencial_nota_debito"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        <vs-input
                            class="w-full"
                            name="text"
                            label="Secuencial de Guia de remisión"
                            v-model="secuencial_guia_remision"
                            disabled
                        />
                        <div v-show="error">
                            <span
                                class="text-danger"
                                v-for="(err,
                                index) in errorsecuencial_guia_remision"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        ...
                        <div v-show="error">
                            <span
                                class="text-danger"
                                v-for="(err,
                                index) in errorsecuencial_retencion"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        <vs-input
                            class="w-full"
                            name="text"
                            label="Secuencial liquidación de compra"
                            v-model="secuencial_liquidacion_compra"
                            disabled
                        />
                        <div v-show="error">
                            <span
                                class="text-danger"
                                v-for="(err,
                                index) in errorsecuencial_liquidacion_compra"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6 imagencudro">
                        <label class="vs-input--label"
                            >Estado de punto de emisión:</label
                        >
                        <vs-checkbox
                            icon-pack="feather"
                            class="mt-3"
                            icon="icon-check"
                            v-model="estado_punto_emision"
                            disabled
                        >
                            ...
                            | <span v-if="estado_punto_emision">Activo</span>
                        ...
                        <div v-show="error">
                            <span
                                class="text-danger"
                                v-for="(err,
                                index) in errorestado_punto_emision"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                ...
                <vs-divider border-style="solid" color="dark"
                    >Configuración de facturación electrónica</vs-divider
                >
                <div class="vx-row">
                    <div class="vx-col sm:w-1/2 w-full mb-6">
                        <vs-input
                    ...
                    <div class="vx-col sm:w-1/2 w-full mb-6">
                        ...
                        />
                        <span class="corto"
                            >dejar vacio si no se requiere cambiar</span
                        >
                    </div>
                    <div class="vx-col sm:w-1/4 w-full mb-6">
                        <vs-input
                    ...
                    <div class="vx-col sm:w-1/4 w-full mb-6">
                        <vs-input
                            ...
                            label="Puerto"
                            onkeypress="return enteros(event,this);"
                            v-model="puerto_correo"
                            maxlength="5"
                        />
                        <span
                            class="text-danger text-sm"
                            v-show="errors.has('puerto')"
                            >Este campo solo lleva numeros</span
                        >
                    </div>
                    <div class="vx-col sm:w-1/4 w-full mb-6">
                        <label class="vs-input--label"
                            >Capa de puerto de correo</label
                        >
                        <ul class="demo-alignment w-full">
                            <li>
                                <vs-radio
                                    v-model="seguridad_correo"
                                    vs-value="ssl"
                                    >Ssl</vs-radio
                                >
                            </li>
                    ...
                    >
                        <label class="vs-input--label"
                            >Opción XML Factura Compra:</label
                        >
                        <div class="mt-1" style="text-align: -webkit-center;">
                            <vs-switch
                                color="success"
                                v-model="xml_factura_compra"
                ...
                <vs-divider border-style="solid" color="dark"
                    >Configuracion de Usuario Administrador</vs-divider
                >
                <div class="vx-row">
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        <vs-input
                        ...
                        <div v-show="error">
                            <span
                                class="text-danger"
                                v-for="(err, index) in errornombreusuario"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        ...
                        <div v-show="error">
                            <span
                                class="text-danger"
                                v-for="(err, index) in errorapellidousuario"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/3 w-full mb-6">
                        ...
                        <div v-show="error">
                            <span
                                class="text-danger"
                                v-for="(err, index) in erroremailusuario"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/2 w-full mb-6">
                        ...
                        <div v-show="error">
                            <span
                                class="text-danger"
                                v-for="(err, index) in errorpassusuario"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                    ...
                    <div class="vx-col sm:w-1/2 w-full mb-6">
                        ...
                        <div v-show="error">
                            <span
                                class="text-danger"
                                v-for="(err, index) in errorrepassusuario"
                                :key="index"
                                v-text="err"
                            ></span>
                        </div>
                ...
                <vs-collapse style="display:none">
                    <vs-collapse-item
                        icon-pack="feather"
                    ...
                    >
                        ...
                        <div class="vx-row">
                            <vs-divider border-style="solid" color="dark"
                                >Permisos de módulos de la empresa</vs-divider
                            >
                            <div class="vx-col sm:w-full w-full mb-6">
                                <div
                                    slot="header"
                                    style="margin-left: 13px;padding: 16px 0;font-weight: bold;font-size: 22px;display: inline-flex;"
                                >
                                    Administrar
                                    <vs-checkbox
                                        class="selectall"
                        ...
                        <div class="form-group">
                            <label class="btn btn-primary" v-if="recuperafirma">
                                <input
                                    type="file"
                                    accept=".p12"
                                    @change="seleccionarp12"
                                    class="seleccionarp12"
                                    name="myfile"
                                    style="display:none"
                                    disabled
                                />
                                <vs-button
                                    ...
                                    @click="agregarp12"
                                    disabled
                                    >No ha ingresado una firma electrónica
                                    !Agregar una!</vs-button
                                >
                                <vs-button
                                    v-else
                                    color="primary"
                                    ...
                                    @click="eliminarp12"
                                    disabled
                                    >Firma agregado exitosamente con nombre de:
                                    {{ p12 }} <br />
                                    <b
                                        >!Click para eliminar y agregar otro¡</b
                                    ></vs-button
                                >
                            </label>
                            ...
                            >
                                ...
                                <flat-pickr
                                    class="w-full"
                                    placeholder="Fecha de expiración"
                                    v-model="fecha_expiracion_firma"
                                    disabled
                                />
                                <vs-input
                                    type="password"
        ...
        <vs-popup title="Plan Cuentas" :active.sync="abrircuentas">
            <div class="con-exemple-prompt">
                <vs-input
                    ...
                    v-model="buscar"
                    @keyup="listarplancuentas(1, buscar)"
                    v-bind:placeholder="i18nbuscar"
                />
                <vs-table
                    stripe
                    v-model="escogervalorcuenta"
                    @selected="escogercuenta"
                    :data="arraycuentas"
                >
                    <template slot="thead">
...
export default {
    ...
    methods: {
        listarempresa() {
            axios
                .get("/api/listarempresa/" + this.usuario.id_empresa)
                .then(res => {
                    console.log(res);
                    ...
                    this.secuencial_nota_credito =
                        res.data.secuencial_nota_credito;
                    this.secuencial_nota_debito =
                        res.data.secuencial_nota_debito;
                    this.secuencial_guia_remision =
                        res.data.secuencial_guia_remision;
                    this.secuencial_retencion = res.data.secuencial_retencion;
                    this.secuencial_liquidacion_compra =
                        res.data.secuencial_liquidacion_compra;
                    ...
                    this.fecha_expiracion_firma =
                        res.data.fecha_expiracion_firma;
        ...
        guardar() {
            ...
            axios.post("/api/actualizarempresa", formData).then(res => {
                axios
                    .post("/api/agregarempresarolesid", {
                        roles: this.items,
                    ...
                    .then(() => {
                        this.$vs.notify({
                            ...
                            text: "La empresa se actualizado exitosamente",
                            color: "success"
                        });
                        location.reload();
                    });
        ...
        validar() {
            ...
            if (!this.secuencial_nota_credito) {
                this.errorsecuencial_nota_credito.push(
            ...
            if (!this.secuencial_guia_remision) {
                this.errorsecuencial_guia_remision.push(
                    "Secuencial obligatorio"
                );
                this.error = 1;
            ...
            if (!this.secuencial_liquidacion_compra) {
                this.errorsecuencial_liquidacion_compra.push(
                    "Secuencial obligatorio"
                );
                this.error = 1;
        ...
        validarrucrepresentante($event) {
            if (this.tipo_identidicacion == "Ruc") {
                ...
                var d10 = numero.substr(9, 1);
                if (d3 == 7 || d3 == 8) {
                    this.erroridentificacion_representante.push(
        ...
        listarroles() {
            axios
                .get("/api/empresaroles/" + this.usuario.id_empresa)
                .then(({ data }) => {
                    this.items = data;
                    this.verificaritems();
                });
                ...
                .then(({ data }) => {
                    if (data == "Enviado") {
                        ...
                        this.$vs.notify({
                            ...
                            text:
                                "Verifique los datos de envio de correo e intente nuevamente",
                            color: "danger"
                        });
                    }
                })
