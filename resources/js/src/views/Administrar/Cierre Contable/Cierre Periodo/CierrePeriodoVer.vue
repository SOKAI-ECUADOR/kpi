    ...
    computed: {
        ...
        Diferencia(){
            if(this.debe>this.haber){
                ...
                if(num<0){
                    this.diferencia_debe=num*-1;
                }else{
                    this.diferencia_debe=num;
                }
            ...
            if(this.debe<this.haber){
                ...
                if(num2<0){
                    this.diferencia_haber=num2*-1;
                }else{
                    this.diferencia_haber=num2;
                }
        ...
        listarCierre(){
            if(this.$route.params.id){
                ...
                axios.get(url).then(({data})=>{
                    this.numero=data.cabecera[0].numero;
                    this.codigo=data.cabecera[0].codigo;
                    this.fecha=data.cabecera[0].fecha;
                    this.periodo=data.cabecera[0].periodo;
                    this.razon_social=data.cabecera[0].razon_social;
                    this.concepto=data.cabecera[0].concepto;
                    this.id_proyecto=data.cabecera[0].id_proyecto;
