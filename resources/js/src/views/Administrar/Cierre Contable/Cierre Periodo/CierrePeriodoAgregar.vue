        ...
        <vx-card>
            ...
            {{cta_resultado_valor}}
                <div class="vx-col xs:w-10/12 sm:w-11/12">
                    <div class="vx-row">
                        ...
                        <div class="vx-col sm:w-2/12 w-full mb-6" v-if="resultado[index].otro_saldo>0">
                            <vs-input
                                :disabled="true"
                                class="w-full valores"
            ...
            <div class="flex w-full">
                <vs-button
                    ...
                    v-if="detalle.length > 0 && resultado.length > 0"
                    >GUARDAR</vs-button
                >
                <vs-button
...
export default {
    ...
    computed: {
        ...
        asignar_cierre(){
            if(this.fecha!==""){
                ...
                this.concepto="Cierre Balance "+anio;
            }
        },
        cta_resultado_valor(){
            var total=0;
            if(this.resultado.length>0){
                this.resultado.forEach(rl=>{
                    this.resultado_valor=parseFloat(rl.saldo);
                });
                console.log(parseFloat(this.resultado[0].saldo));
            }
        ...
        Diferencia(){
            if(this.debe>this.haber){
                ...
                if(num!==0){
                    ...
                    if(num<0){
                        ...
                        console.log("cta_resultado 1:"+this.resultado_valor);
                        
                    }else{
                        this.diferencia_haber=num;
                        console.log("cta_resultado 2: "+this.resultado_valor);
                        // if(this.cta_resultado_valor==this.diferencia_haber){
                        //      this.diferencia_haber=0;
                        // }
                    }
            ...
            if(this.debe<this.haber){
                ...
                console.log(num2+":numero_diferencia");
                if(num2!==0){
                    if(num2<0){
                        this.diferencia_debe=num2*-1;
                        console.log("cta_resultado 3: "+this.resultado_valor+" "+this.diferencia_debe);
                        // if(this.cta_resultado_valor==this.diferencia_debe){
                        //      this.diferencia_debe=0;
                        // }
                    }else{
                        this.diferencia_debe=num2;
                        console.log("cta_resultado 4: "+this.cta_resultado_valor);
                        // if(this.cta_resultado_valor==this.diferencia_debe){
                        //      this.diferencia_debe=0;
                        // }
                    }
            ...
            console.log("el debe es:"+this.debe+" el haber es:"+this.haber);
    ...
    methods:{
        ...
        listar(){
            var url="/api/ejercicio_contable";
            axios.get(url,{
                params:{
        ...
        guardarAsientoContable(){
                    ...
                    let url = `/api/ejercicio_contable/guardar/asiento`;
                    axios
                        .post(url, {
                            numero:this.numero,
                            codigo:this.codigo,
            ...
            if(this.resultado.length<=0){
                ...
                this.resultado.forEach(el=>{
                    if(el.id_proyecto==null || el.id_proyecto==""){
                        ...
                        console.log("No se encuentra el proyecto  resultado");
                    }
                    if(el.id_plan_cuentas==null || el.id_plan_cuentas==""){
                        error++;
                        this.$vs.notify({
                        ...
                        console.log("No se encuentra el plan_cuentas  resultado");  
                    }
                });
            }
            return error;
        ...
        agregarDetalle(id){
                    let url = `/api/ejercicio_contable/guardar/detalle`;
                    axios
                        .post(url, {
                            id_asientos:id,
                        ...
                        .then(response => {
                            ...
                            this.$router.push("/administrar/cierre_contable/ejercicio_contable");
                        })
                        .catch(err => {
                            this.$vs.notify({
                                title: "Error al Guardar",
        ...
        listarCierre(){
            if(this.$route.params.id){
                var url="/api/ejercicio_contable/listar_cierre/"+this.$route.params.id;
