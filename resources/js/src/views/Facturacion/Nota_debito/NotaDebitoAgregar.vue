    ...
    <div id="invoice-page">
        <vx-card>
            <vs-divider position="center">
                <h3 v-if="factura.clave_acceso">Nota de Débito N° {{(factura.clave_acceso).substring(24,27)}}-{{(factura.clave_acceso).substring(27,30)}}-{{(factura.clave_acceso).substring(30,39)}}</h3>
            ...
            <div class="vx-row leading-loose p-base">
                ...
                <div class="vx-col sm:w-3/5 w-full mb-6" style="position: relative;">
                    ...
                    <div class="busqueda_lista busqueda_factura_ls" style="display: none;width: 96%!important;">
                    ...
                    <vs-table hoverFlat :data="producto.lista_productos" style="font-size: 12px;">
                        ...
                        <template slot-scope="{ data }">
                            <vs-tr v-for="(tr, index) in data" :key="index" class="fila_lista">
                                <vs-td class="text-center" style="width:100px!important;" v-if="tr.cod_alterno">{{tr.cod_alterno}}</vs-td><vs-td v-else>{{ tr.cod_principal }}</vs-td>
...
export default {
    ...
    methods: {
        ...
        guardar_factura(){
            ...
            axios.post('/api/notadebito/guardar_factura', {
