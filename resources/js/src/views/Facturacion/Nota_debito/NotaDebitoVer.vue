    ...
    <div id="invoice-page">
        <vx-card>
            ...
            <div class="vx-row leading-loose p-base">
                ...
                <div class="vx-col sm:w-1/5 w-full mb-2 text-center">
                    <h6>Fecha:</h6>
                    {{ cuerpo.fecha_emision | fecha }}
                </div>
                <div class="vx-col sm:w-3/5 w-full mb-2 text-center" v-if="cuerpo.autorizacionfactura">
            ...
            <div class="p-base">
                ...
                <div class="vx-col w-full">
                    <vs-button color="danger" type="filled" to="/facturacion/nota-debito">Regresar</vs-button>
                </div>
            </div>
        </vx-card>
    </div>
...
export default {
    ...
    methods: {
        listar() {
            var url = "/api/vernotadebito/" + this.$route.params.id;
