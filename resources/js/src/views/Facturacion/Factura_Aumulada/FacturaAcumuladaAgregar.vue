                    ...
                    <vs-table hoverFlat :data="producto.lista_productos" style="font-size: 12px;">
                        ...
                        <template slot-scope="{ data }">
                            ...
                            <vs-td v-if="tr.cod_alterno">{{tr.cod_alterno}}</vs-td><vs-td v-else>{{ tr.cod_principal }}</vs-td>
                                ...
                                <feather-icon icon="DollarSignIcon" svgClasses="w-6 h-6 hover:text-primary stroke-current cursor-pointer" class="eliminar_producto_icono" @click="precio_producto(index)" v-if="usuario.id_empresa==59 || usuario.id_empresa==55"/>
    ...
    methods: {
        ...
        enviarfactura(){
            axios.post('/api/factura_acumulada/guardar_factura', {
                ...
                this.id_factura_imp=data.nota_venta[0].id_nota_venta;
