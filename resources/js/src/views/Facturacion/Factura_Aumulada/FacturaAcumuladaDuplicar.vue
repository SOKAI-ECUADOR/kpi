        ...
        <vx-card>
            ...
            <div class="vx-row" v-if="creditos.estado && exist_interes==1 && interes_monto>0">
                   ...
                   <div class="vx-col sm:w-1/4 w-full mb-2 text-center">
                        ...
                        <div class="mt-2">$ {{creditos.monto}}</div>
                    </div>
                    <div class="vx-col sm:w-1/4 w-full mb-2 text-center">
...
export default {
    ...
    computed: {
        ...
        total_interes_monto(){
            ...
            if(this.interes_monto>0){
                total=Number(this.interes_monto)+Number(this.creditos.monto);
            }
            return total.toFixed(2);
        },
        total_interes_saldo(){
        ...
        total_pendiente(){
            ...
            this.cuotas_extras.datos.forEach(el => {
                if(parseFloat(el.valor_pago)>0){
                    cuota=parseFloat(el.valor_pago)
                }
                cuotas += cuota;
            });
            ...
            console.log("pendiente:"+parseFloat(this.formulas.total)+" Cuotas"+parseFloat(cuotas)+"=");
    ...
    methods: {
        ...
        enviarfactura(){
            axios.post('/api/factura_acumulada/guardar_factura', {
        ...
        validar(){
            ...
            for (var i = 0; i < this.producto.lista_productos.length; i++) {
                ...
                console.log(this.cliente.id_plan_seguro+"plns");
                if(this.cliente.id_plan_seguro!==null && this.cliente.id_plan_seguro>0){
                    console.log(this.producto.lista_productos[i].descuento_seguro+"descpl");
    ...
    created(){
        var duplicar = localStorage.getItem("duplicar");
        axios.get("/api/nota_venta/duplicar?id=" + duplicar).then(({data}) => {
            ...
            if((data.cuota_extra).length>0){
                ...
                data.cuota_extra.forEach(el=>{
                    this.cuotas_extras.datos.push({
                        ...
                        id_cuota_extra:el.id_cuota_extra_factura
                    });
                });
            }
            ...
            this.cliente = {
                ...
                id_plan_seguro:data.cliente.id_planseguro
            }
            if(this.usuario.id_empresa==59){
