<template>
    <vx-card>
        ...
        <div class="flex flex-wrap">
            ...
            <div class="sm:w-full md:w-1/3 w-1/3 md:ml-auto mb-6" v-if="usuario.id_rol!=2">
        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full mb-6 flex">
                <label for="sections" class="flex mb-2 w-48"
                    >Productos
                    <vs-switch v-model="products.withProducts" class="ml-5" />
                </label>
                <label for="sections" class="flex mb-2 w-64" v-if="products.withProducts"
                    >Ventas VS Costos
                    <vs-switch v-model="products.productsVsCost" class="ml-5" @click="products.facturaVsCost=false" />
                </label>
                <label for="sections" class="flex mb-2 w-72" v-if="products.withProducts"
                    >Ventas VS Costos Por Factura
                    <vs-switch v-model="products.facturaVsCost" class="ml-5" @click="products.productsVsCost=false" />
                </label>
                <!-- <v-select
    ...
    methods: {
        ...
        sendData() {
            let response = {
                ...
                ProductoVSCostos: this.products.withProducts&&this.products.productsVsCost
                    ? true
                    : false,
                FacturaVSCostos: this.products.withProducts&&this.products.facturaVsCost
                    ? true
                    : false
            };
