<template>
    <vx-card>
        ...
        <div class="flex flex-wrap mt-3 mb-3" style="align-items: center;">
            <label class="mr-2">Proformas con valor total</label>
            <vs-radio
    ...
    methods: {
        ...
        searchByEstablishment(establishment) {
            if (establishment !== null) {
                ...
                lista.length != 1 
                    ? this.invoice.pointOfEmission.pointsOfEmissionListByEstablishment.push(...lista)
