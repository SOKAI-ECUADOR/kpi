<template>
    <vx-card>
        <div class="flex flex-wrap">
            ...
            <div class="sm:w-full md:w-1/2 w-1/2 mb-6 pr-3 pl-3">
        ...
        <div class="flex flex-wrap">
            ...
            <div class="sm:w-full md:w-1/2 w-1/2 md:ml-auto mb-6" v-if="usuario.id_rol!=2 || (usuario.nombres=='Erick' && usuario.apellidos=='Zambrano Mendoza')">
                <!-- <div class="sm:pl-0 md:pl-3 sm:w-full pl-3" hidden>
...
export default {
    ...
    methods: {
        ...
        sendData() {
            let response = {
                ...
                user_lastname:this.usuario.apellidos,
                users:this.user.selectedUser
            };
    ...
    async mounted() {
        try {
            ...
            if(this.usuario.id_rol!==2 || (this.usuario.nombres=='Erick' && this.usuario.apellidos=='Zambrano Mendoza')){
