<template>
    <vx-card>
        ...
        <div class="flex flex-wrap">
            <div class="sm:w-full md:w-6/12 w-6/12 mb-6" hidden>
            ...
            <div class="sm:w-full md:w-full w-full md:ml-auto mb-6">
        ...
        <div class="flex flex-wrap mt-3 mb-3" style="align-items: center;" hidden>
...
export default {
    ...
    async mounted() {
        try {
            ...
            //     }))
            // );
            //if(this.usuario.id_rol!==2 || this.usuario.id_empresa==59){
