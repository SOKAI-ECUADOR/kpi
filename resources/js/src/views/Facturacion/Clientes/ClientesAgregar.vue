                ...
                <div class="vx-row">
                    ...
                    <div class="vx-col sm:w-full w-full mb-6">
                        <div style="display: flex; align-items: center;">
                            ...
                            label="E-mail"
                            v-model="email"
                            @keyup.enter="addCorreo()"
                            />
                            <feather-icon v-if="isMobile()" @click="addCorreo()" icon="PlusIcon" style="margin-top: 20px;" svgClasses="w-6 h-6 hover:text-primary stroke-current cursor-pointer" class="eliminar_producto_icono" />
                        </div>
                        <div v-show="error">
                            <span
                                class="text-danger"
                    ...
                    <div class="vx-col sm:w-1/4 w-full mb-6">
                        <vs-input
                            class="w-full"
                            label="Régimen Contribuyente"
                            v-model="regimen_contribuyente"
                        />
                    </div>
                    <div class="vx-col sm:w-1/4 w-full mb-6">
                        <vs-select
                            ...
                            label="Seguro"
                            @change="
                                listarplanseguro(seguro);
                                plan_seguro = '';
                            "
                        >
                            <vs-select-item
                                :key="item.id_seguro"
                                :value="item.id_seguro"
                                :text="item.nombre"
                                v-for="item in contenidoseguro"
                            />
                        </vs-select>
                    </div>
                    <div class="vx-col sm:w-1/4 w-full mb-6">
                        ...
                        >
                            <vs-select-item
                                :key="item.id_plan_seguro"
                                :value="item.id_plan_seguro"
                                :text="item.nombre"
                                v-for="item in contenidoplanseguro"
                            />
                        </vs-select>
                    </div>
                    <div class="vx-col sm:w-full w-full mb-6">
...
export default {
    ...
    methods: {
        ...
        addCorreo(){
            ...
            if(this.email != ""){
                this.chip_correo.push(this.email);
                this.email = "";
            }
        },
        isMobile() {
            let flag = navigator.userAgent.match (// Método de coincidencia puede recuperar el valor especificado en la cadena,
