        ...
        <vx-card>
            <div class="flex flex-wrap justify-between items-center mb-3">
                ...
                >
                    ...
                    <vs-button class="btnx" type="filled" to="/verificacion_activos/agregar_carga">Cargar Archivo</vs-button>
            ...
            <vs-table stripe max-items=25 pagination :data="contenido">
                ...
                <template slot-scope="{ data }">
                    <vs-tr :key="datos.id" v-for="datos in data" class="text-center">
                        ...
                        <vs-td v-if="datos.nombre_archivo">
                            {{ datos.nombre_archivo }}
                        </vs-td>
                        <vs-td v-if="datos.estado">
                            {{ datos.estado }}
                        </vs-td>
                        <vs-td v-if="datos.acta_estado_nombre">
                            {{ datos.acta_estado_nombre }}
                        </vs-td>
                        <vs-td v-if="datos.nombres">
                            {{ datos.nombres }} &nbsp; {{ datos.apellidos }}
                        </vs-td>
                        <vs-td v-if="datos.fecha_subida">
                            {{ datos.fecha_subida }}
                        </vs-td>
                        <vs-td class="whitespace-no-wrap">
                            ...
                            <feather-icon icon="TrashIcon" svgClasses="w-5 h-5 hover:text-danger stroke-current"
                                class="ml-2 cursor-pointer" @click.stop="eliminarVehiculo(datos.id)" />
                        </vs-td>
                    </vs-tr>
                </template>
            </vs-table>
...
export default {
    ...
    methods: {
        listar_carga(page1, buscar) {
            var url ="/api/listaractascargaarchivo/"+this.usuario.id_empresa +"?page=" +page1;
