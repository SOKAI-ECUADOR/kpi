    ...
    <div id="ag-grid-demo">
        <vx-card>
                ...
                >
                    ...
                    <div class="dropdown-button-container">
                        <vs-button
                            class="btnx"
                            type="filled"
                            to="/verificacion_activos/agregar_acta"
                            >Crear Acta Asignación de Activos</vs-button
                        >
                        <vs-dropdown>
                            <vs-button
                                class="btn-drop"
            ...
            <vs-table stripe max-items=25 pagination :data="contenido">
                <template slot="thead">
                    <vs-th class="text-center"># Acta</vs-th>
                    <vs-th class="text-center">Agencia</vs-th>
                    <vs-th class="text-center">Perìodo</vs-th>
                ...
                <template slot-scope="{ data }">
                    <vs-tr :key="datos.acta_asignacion_activo_id" v-for="datos in data" class="text-center">
                        <vs-td v-if="datos.acta_asignacion_activo_id">
                            {{ datos.acta_asignacion_activo_id}}
                        </vs-td>
                        <vs-td v-if="datos.acta_agencia_nombre">
                            {{ datos.acta_agencia_nombre }}
                        </vs-td>
                        <vs-td v-if="datos.periodo">
                            {{ datos.periodo }}
                        </vs-td>
                        <vs-td v-if="datos.acta_estado_nombre">
                            {{ datos.acta_estado_nombre }}
                        </vs-td>
                        <vs-td v-if="datos.acta_fecha_creacion">
                            {{ datos.acta_fecha_creacion }}
                        </vs-td>
                        <vs-td class="whitespace-no-wrap">
                            <feather-icon icon="EditIcon" svgClasses="w-5 h-5 hover:text-primary stroke-current"
                                class="cursor-pointer" @click.stop="editar(datos.acta_asignacion_activo_id)" />
                            &nbsp;
                            <feather-icon icon="TrashIcon" svgClasses="w-5 h-5 hover:text-danger stroke-current"
                                class="ml-2 cursor-pointer" @click.stop="eliminarVehiculo(datos.acta_asignacion_activo_id)" />
                        </vs-td>
                    </vs-tr>
                </template>
            </vs-table>
...
export default {
    ...
    methods: {
        listar(page1, buscar) {
            var url ="/api/listaractasasignacionactivos/"+this.usuario.id_empresa +"?page=" +page1;
        ...
        editar(id) {
            this.$router.push(`/verificacion_activos/agregar_acta/${id}/editar`); 
        },
