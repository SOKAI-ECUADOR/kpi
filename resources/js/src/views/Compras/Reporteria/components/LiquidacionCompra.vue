<template>
    <vx-card>
        ...
        <div class="flex flex-wrap">
            <div class="sm:w-full md:w-1/2 w-1/3 mb-6">
            ...
            <div class="sm:w-full md:w-1/2 w-1/3 mb-6 pr-3 pl-3">
        ...
        <div class="flex flex-wrap">
            ...
            <div class="sm:w-full md:w-1/2 w-1/3 mb-6 pr-3 pl-3" v-if="usuario.id_rol!==2">
        ...
        <div class="flex flex-wrap mt-3 mb-3" style="align-items: center;">
            <label class="mr-2">Liquidaciones</label>
            <vs-switch
                v-if="!invoice.all"
