        ...
        <vx-card>
            ...
            <div class="vx-row leading-loose p-base">
                ...
                <div class="vx-col sm:w-1/2 w-full mb-6">
                    ...
                    <flat-pickr :config="configdateTimePicker" disabled class="w-full" v-model="factura.fecha_validez" placeholder="Seleccionar"></flat-pickr>
                </div>
                <div class="vx-col sm:w-1/3 w-full mb-6" hidden>
                    <h6 class="mb-1"> Número de Autorizacion:</h6>
                    <vs-input class="w-full" disabled v-model="factura.autorizacion"/>
                ...
                <div class="vx-col sm:w-1/3 w-full mb-6">
                    ...
                    <vs-select placeholder="buscar" disabled autocomplete class="selectExample w-full" v-model="factura.tipo_sustento">
                ...
                <div class="vx-col sm:w-1/3 w-full mb-6">
                    ...
                    <vs-select placeholder="buscar" disabled autocomplete class="selectExample w-full" v-model="factura.destino_pago">
                ...
                <div class="vx-col sm:w-1/3 w-full mb-6">
                    ...
                    <ul class="demo-alignment">
                      <li style="margin: 13px 1.5rem;">
                        <vs-radio v-model="factura.gastos" disabled vs-value="1g">Si</vs-radio>
                      </li>
                      <li style="margin: 13px 1.5rem;">
                        <vs-radio v-model="factura.gastos" disabled vs-value="0g">No</vs-radio>
                      </li>
                    </ul>
                </div>
                <div class="vx-col sm:w-2/5 w-full mb-6" v-if="parseInt(factura.gastos)==1">
                    <h6 class="mb-1">Nro Importacion:</h6>
                    <vs-select class="selectExample w-full" disabled placeholder="Seleccione una importacion" v-model="factura.importacion">
                ...
                <div class="vx-col sm:w-2/5 w-full mb-6 ml-auto">
                    ...
                    <vs-input class="w-full" disabled v-model="factura.orden_compra"/>
                </div>
                <div class="vx-col sm:w-1/5 w-full mb-6 mr-auto">
                    <h6 class="mb-1">Documento Tributario:</h6>
                    <ul class="demo-alignment">
                      <li style="margin: 13px 1.5rem;">
                        <vs-radio v-model="factura.docutributario" disabled vs-value="1">Si</vs-radio>
                      </li>
                      <li style="margin: 13px 1.5rem;">
                        <vs-radio v-model="factura.docutributario" disabled vs-value="0">No</vs-radio>
                      </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="vx-row leading-loose p-base">
                ...
                <div class="vx-col sm:w-full w-full mb-6 relative" v-else>
                    <vs-input class="w-full busqueda_cliente" disabled placeholder="Escoge un cliente Para agregar un Comprobante" v-model="cliente.busqueda" @keyup="listar_cliente(cliente.busqueda)"/>
            ...
            <div class="vx-row leading-loose p-base">
                    ...
                    <vs-table hoverFlat :data="producto.lista_productos" style="font-size: 12px;">
                        ...
                        <template slot-scope="{ data }">
                            <vs-tr v-for="(tr, index) in data" :key="index" class="fila_lista">
                                ...
                                <vs-td>
                                    <vs-select class="selectExample w-full" disabled placeholder="Seleccione un proyecto" v-model="tr.proyecto">
                                        <vs-select-item :key="index" :value="item.id_proyecto" :text="item.descripcion" v-for="(item, index) in proyectos_menu"/>
                                    </vs-select>
                                ...
                                <vs-td style="width:175px!important;" v-else>
                                    <vs-select placeholder="buscar" disabled  autocomplete class="selectExample w-full" v-model="tr.id_bodega">
                ...
                <div class="vx-col sm:w-full w-full mb-6 relative" v-if="factura.respuesta != 'Enviado' && factura.cuentas<1">
                    <vs-input class="w-full busqueda_cliente focuspr" disabled placeholder="Agrega productos a esta factura" v-model="producto.busqueda"  @keyup="listar_productos(producto.busqueda)"/>
                    <feather-icon icon="SearchIcon" svgClasses="w-8 h-8 hover:text-primary stroke-current cursor-pointer" class="busqueda_cliente_icono"/>
                        ...
                        <div class="vx-col sm:w-1/2 w-full">
                            <div class="cabezera_total">
                                ...
                                <div>PROPINA
                                    <span>
                                        <vx-input-group>
                                            <vs-input class="w-full" disabled placeholder="$0.00" v-model="propinapr"/>
                                            <template slot="append">
                                                <div class="append-text btn-addon">
                                                    <button disabled class="botonstl" :class="{'botonstl elejido':pp_descuento == 1,botonstl:pp_descuento != 1 }" @click="pp_descuento = 1">
                                                        $
                                                    </button>
                                                    <button disabled class="botonstl" :class="{ 'botonstl elejido': pp_descuento == 0, botonstl: pp_descuento != 0 }" @click="pp_descuento = 0">
                                                        %
                                                    </button>
                                                </div>
                                            </template>
            ...
            <vs-divider position="left" class="flexy">
                <h3>Créditos</h3>
                <vs-switch vs-icon-on="check" disabled color="success" v-model="creditos.estado" class="ml-2" @click="cambioscreditos()" vs-value="Si" style="margin-top: 4px;">
            ...
            <transition name="slide-fade">
                <div class="vx-row leading-loose p-base" v-if="creditos.estado">
                    ...
                    <div class="vx-col sm:w-1/6 w-full mb-2 text-center">
                        <vs-input class="w-full text-center" disabled label="Tiempos Pago" v-model="creditos.tiempo"/>
                    </div>
                    <div class="vx-col sm:w-1/6 w-full mb-2 text-center">
                    ...
                    <div class="vx-col sm:w-1/6 w-full mb-2 text-center">
                        <vs-input class="w-full text-center" disabled label="Monto de pago" v-model="creditos.monto"/>
                    </div>
                    <div class="vx-col sm:w-1/6 w-full mb-2 text-center">
                    ...
                    <div class="w-full">
                        <div class="vx-row hovertrash" v-for="(tr,index) in pagos.datos" :key="index">
                            ...
                            <div class="vx-col sm:w-1/6 w-full mb-2 text-center mr-auto" v-if="tr.metodo_pago=='Anticipo'">
                                <vs-input disabled class="w-full text-center" label="Anticipo Total"  :value="anticipoexistente"/>
                            </div>
                            <div class="vx-col sm:w-1/6 w-full mb-2 text-center" v-if="tr.metodo_pago!='Anticipo'">
                            ...
                            <div class="vx-col sm:w-1/6 w-full mb-2" v-if="tr.metodo_pago!='Anticipo'">
                                <label class="vs-input--label">Plan Cuenta</label>
                                    ...
                                    <vs-input disabled class="w-full" v-model="tr.cuenta"/>
