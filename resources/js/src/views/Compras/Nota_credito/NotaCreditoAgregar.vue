    ...
    <div id="invoice-page">
        <vx-card>
            <vs-divider position="center">
                ...
                <h3 v-else>Nota de Crédito Compra</h3>
            </vs-divider>
            ...
            <div class="vx-row leading-loose p-base" v-if="producto.tipo">
                <div class="vx-col sm:w-full w-full relative">
                    <vs-table hoverFlat :data="producto.lista_productos" >
                        <template slot="thead">
                        ...
                        <template slot-scope="{ data }">
                            <vs-tr v-for="(tr, index) in data" :key="index" class="fila_lista">
                                <vs-td class="text-center" style="width:100px!important;" v-if="tr.cod_alterno">{{tr.cod_alterno}}</vs-td>
                                <vs-td class="text-center" style="width:100px!important;" v-else>{{ tr.cod_principal }}</vs-td>
                                ...
                                <vs-td class="text-center" style="width:120px!important;" v-if="tr.descuento && tr.sector==1">
                                ...
                                <vs-td class="text-center" style="width:120px!important;" v-else-if="tr.descuento && tr.sector==2">
                                    <template v-if="tr.p_descuento==1">
...
export default {
    ...
    methods: {
        ...
        guardar_factura(){
            ...
            axios.post('/api/notacreditocompra/guardar_factura', {
                ...
                if(resp.data=="valores"){
                    this.$vs.notify({
                        title: "La nota de crédito excede al valor de la factura",
                        color: "danger"
                    });
                    this.disabled_button=false;
                    return;
        ...
        validar(){
            ...
            for (var i = 0; i < this.producto.lista_productos.length; i++) {
                ...
                if (!this.producto.lista_productos[i].cantidad || this.producto.lista_productos[i].cantidad==0 || this.producto.lista_productos[i].cantidad=="0") {
                    this.producto.lista_productos[i].errorcantidad.push("Obligatorio");
                    this.error.error = 1;
                }
                if (!this.producto.lista_productos[i].precio || this.producto.lista_productos[i].precio==0 || this.producto.lista_productos[i].precio=="0") {
