      ...
      <vs-tab title="BasicInfo" label="Ingresos" icon-pack="feather" icon="icon-book-open">
        <div class="vx-row">
          ...
          <label class="vs-input--label">Fecha</label>
            ...
            <flat-pickr :config="configdateTimePicker" v-model="fechrol"  disabled/>
            ...
            <template slot-scope="{data}">
              <vs-tr v-for="(tr, index) in data" :key="index">
                ...
                <vs-td :data="tr.cantidad" style="width:50px!important;">
                  <vs-input class="w-full"  v-model="tr.cantidad" disabled/>
                ...
                <vs-td :data="tr.sueldo" style="width:140px!important;text-align:right;" v-if="$route.params.id">
                  {{tr.sueldo | currency}}
                </vs-td>
                <vs-td :data="tr.sueldo" style="width:140px!important;text-align:right;" v-else>
                ...
                <vs-td :data="tr.totalingreso" style="width:140px!important;text-align:right;" v-if="$route.params.id">
                  {{(parseFloat(tr.sueldo))+parseFloat(tr.ingreso1)+parseFloat(tr.ingreso2)+parseFloat(tr.ingreso3)+parseFloat(tr.ingreso4)+parseFloat(tr.ingreso5)+parseFloat(tr.ingreso6)+parseFloat(tr.decimo_tercero)+parseFloat(tr.decimo_cuarto)+parseFloat(tr.fondo_reserva) |currency}}
                </vs-td>
                <vs-td :data="tr.totalingreso" style="width:140px!important;text-align:right;" v-else>
            ...
            <template slot-scope="{data}">
              <vs-tr v-for="(tr, index) in data" :key="index">
               <!-- <vs-td v-if="!iddepart" :data="tr.id_empleado" style="width:100px!important;">{{ tr.id_empleado }}</vs-td>
                ...
                <vs-td :data="tr.iess" style="width:100px!important;text-align:right;" v-if="$route.params.id">
                  {{((parseFloat(tr.sueldo))+parseFloat(tr.valor_ingreso1)+parseFloat(tr.valor_ingreso2)+parseFloat(tr.valor_ingreso3)+parseFloat(tr.valor_ingreso4)+parseFloat(tr.valor_ingreso5)+parseFloat(tr.valor_ingreso6))*(9.45/100) |currency}}
                </vs-td>
                <vs-td :data="tr.iess" style="width:100px!important;text-align:right;" v-else>
                ...
                <vs-td :data="tr.totalegreso" style="width:90px!important;text-align:right;" v-if="$route.params.id">
                  {{parseFloat(tr.egreso1)+(((parseFloat(tr.sueldo))+parseFloat(tr.valor_ingreso1)+parseFloat(tr.valor_ingreso2)+parseFloat(tr.valor_ingreso3)+parseFloat(tr.valor_ingreso4)+parseFloat(tr.valor_ingreso5)+parseFloat(tr.valor_ingreso6))*(9.45/100))+parseFloat(tr.egreso2)+parseFloat(tr.egreso3)+parseFloat(tr.egreso4)+parseFloat(tr.egreso5)+parseFloat(tr.egreso6) |currency}}
                </vs-td>
                <vs-td :data="tr.totalegreso" style="width:90px!important;text-align:right;" v-else>
                ...
                <vs-td :data="tr.valor_recibir" style="width:100px!important;text-align:right;" v-if="$route.params.id">
                  {{((parseFloat(tr.sueldo))+parseFloat(tr.ingreso1)+parseFloat(tr.ingreso2)+parseFloat(tr.ingreso3)+parseFloat(tr.ingreso4)+parseFloat(tr.ingreso5)+parseFloat(tr.ingreso6)+parseFloat(tr.decimo_tercero)+parseFloat(tr.decimo_cuarto)+parseFloat(tr.fondo_reserva))-(parseFloat(tr.egreso1)+(((parseFloat(tr.sueldo))+parseFloat(tr.valor_ingreso1)+parseFloat(tr.valor_ingreso2)+parseFloat(tr.valor_ingreso3)+parseFloat(tr.valor_ingreso4)+parseFloat(tr.valor_ingreso5)+parseFloat(tr.valor_ingreso6))*(9.45/100))+parseFloat(tr.egreso2)+parseFloat(tr.egreso3)+parseFloat(tr.egreso4)+parseFloat(tr.egreso5)+parseFloat(tr.egreso6)) |currency}}
                </vs-td>
                <vs-td :data="tr.valor_recibir" style="width:100px!important;text-align:right;" v-else>
...
export default {
    ...
    valordecimo_cuarto(){
      ...
      this.contenidopr.forEach(el => {
        if(el.decimo_cuarto!=0){
          el.decimo_cuarto=(400/360)*(parseFloat(el.cantidad));
        }
      });
    },
    valordecimo_tercero(){
      ...
      this.contenidopr.forEach(el => {
        if(el.decimo_tercero!=0){
          if(this.$route.params.id){
            el.decimo_tercero=((parseFloat(el.sueldo))+parseFloat(el.valor_ingreso1)+parseFloat(el.valor_ingreso2)+parseFloat(el.valor_ingreso3)+parseFloat(el.valor_ingreso4)+parseFloat(el.valor_ingreso5)+parseFloat(el.valor_ingreso6))/12;
          }else{
    ...
    valorfondo_reserva(){
      ...
      this.contenidopr.forEach(el => {
        if(el.fondo_reserva!=0){
          if(this.$route.params.id){
            el.fondo_reserva=((parseFloat(el.sueldo))+parseFloat(el.valor_ingreso1)+parseFloat(el.valor_ingreso2)+parseFloat(el.valor_ingreso3)+parseFloat(el.valor_ingreso4)+parseFloat(el.valor_ingreso5)+parseFloat(el.valor_ingreso6))/12;
          }else{
  ...
  methods: {
    ...
    totalingreso() {
      ...
      sueldo=this.sueldototal()+this.totalcolum1()+this.totalcolum2()+this.totalcolum3()+this.totalcolum4()+this.totalcolum5()+this.totalcolum6()+this.totaldecimo_tercero()+this.totaldecimo_cuarto()+this.totalfondo_reserva();
    ...
    totaliess(){
      ...
      this.contenidopr.forEach(el => {
        if(this.$route.params.id){
          total += ((parseFloat(el.sueldo))+parseFloat(el.valor_ingreso1)+parseFloat(el.valor_ingreso2)+parseFloat(el.valor_ingreso3)+parseFloat(el.valor_ingreso4)+parseFloat(el.valor_ingreso5)+parseFloat(el.valor_ingreso6))*(9.45/100);
        }else{
    ...
    handleEmpleados(){
      ...
      this.traerIngresos(this.iddepart)
        ...
        .then(value => {
          ...
          return this.traerEmpleado(this.iddepart)
        })
        .then(value => {
          console.log('traer empleado',value)
    ...
    listarrolIngreso(){
       if(this.$route.params.id){
        ...
        var url = "/api/abriringresoRoles/" + this.idrecupera;
        axios
          .get(url)
          .then(res => {
    ...
    async traerEmpleado(){      //console.log("ejecutado empleados");
      var url = "/api/empleadoRoles?id_empleado="+this.iddepart+
      "&ing1="+this.idcolumn1+
      "&ing2="+this.idcolumn2+
      "&ing3="+this.idcolumn3+
      "&ing4="+this.idcolumn4+
