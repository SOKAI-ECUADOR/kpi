                ...
                <div class="p-base">
                    ...
                    >
                        <template slot="thead" id="head">
                            ...
                            <vs-th class="table-header" v-if="array_ineg.length>0 && array_ineg[0].descripcion">{{array_ineg[0].descripcion}}</vs-th>
                            <vs-th class="table-header" v-if="array_ineg.length>1 && array_ineg[1].descripcion">{{array_ineg[1].descripcion}}</vs-th>
                            <vs-th class="table-header" v-if="array_ineg.length>2 && array_ineg[2].descripcion">{{array_ineg[2].descripcion}}</vs-th>
                            <vs-th class="table-header" v-if="array_ineg.length>3 && array_ineg[3].descripcion">{{array_ineg[3].descripcion}}</vs-th>
                            <vs-th class="table-header" v-if="array_ineg.length>4 && array_ineg[4].descripcion">{{array_ineg[4].descripcion}}</vs-th>
                            <vs-th class="table-header" v-if="array_ineg.length>5 && array_ineg[5].descripcion">{{array_ineg[5].descripcion}}</vs-th>
                            <vs-th class="table-header" v-if="array_ineg.length>6 && array_ineg[6].descripcion">{{array_ineg[6].descripcion}}</vs-th>
                            <vs-th class="table-header" v-if="array_ineg.length>7 && array_ineg[7].descripcion">{{array_ineg[7].descripcion}}</vs-th>
                            <vs-th class="table-header" v-if="array_ineg.length>8 && array_ineg[8].descripcion">{{array_ineg[8].descripcion}}</vs-th>
                            <vs-th class="table-header" v-if="array_ineg.length>9 && array_ineg[9].descripcion">{{array_ineg[9].descripcion}}</vs-th>
                            <vs-th class="table-header" v-if="array_ineg.length>10 && array_ineg[10].descripcion">{{array_ineg[10].descripcion}}</vs-th>
                            <vs-th class="table-header" v-if="array_ineg.length>11 && array_ineg[11].descripcion">{{array_ineg[11].descripcion}}</vs-th>
                        ...
                        <template slot-scope="{ data }">
                            ...
                            <vs-tr style="border-top: 1px solid #ddd;font-size: 15px;">
                                ...
                                <th v-if="array_ineg.length>0 && array_ineg[0].descripcion" style="text-align:right;"><h5>{{totalvalorcolum0 | currency}}</h5></th>
                                <th v-if="array_ineg.length>1 && array_ineg[1].descripcion" style="text-align:right;"><h5>{{totalvalorcolum1 | currency}}</h5></th>
                                <th v-if="array_ineg.length>2 && array_ineg[2].descripcion" style="text-align:right;"><h5>{{totalvalorcolum2 | currency}}</h5></th>
                                <th v-if="array_ineg.length>3 && array_ineg[3].descripcion" style="text-align:right;"><h5>{{totalvalorcolum3 | currency}}</h5></th>
                                <th v-if="array_ineg.length>4 && array_ineg[4].descripcion" style="text-align:right;"><h5>{{totalvalorcolum4 | currency}}</h5></th>
                                <th v-if="array_ineg.length>5 && array_ineg[5].descripcion" style="text-align:right;"><h5>{{totalvalorcolum5 | currency}}</h5></th>
                                <th v-if="array_ineg.length>6 && array_ineg[6].descripcion" style="text-align:right;"><h5>{{totalvalorcolum6 | currency}}</h5></th>
                                <th v-if="array_ineg.length>7 && array_ineg[7].descripcion" style="text-align:right;"><h5>{{totalvalorcolum7 | currency}}</h5></th>
                                <th v-if="array_ineg.length>8 && array_ineg[8].descripcion" style="text-align:right;"><h5>{{totalvalorcolum8 | currency}}</h5></th>
                                <th v-if="array_ineg.length>9 && array_ineg[9].descripcion" style="text-align:right;"><h5>{{totalvalorcolum9 | currency}}</h5></th>
                                <th v-if="array_ineg.length>10 && array_ineg[10].descripcion" style="text-align:right;"><h5>{{totalvalorcolum10 | currency}}</h5></th>
                                <th v-if="array_ineg.length>11 && array_ineg[11].descripcion" style="text-align:right;"><h5>{{totalvalorcolum11 | currency}}</h5></th>
                            </vs-tr>
...
export default {
    ...
    methods: {
        ...
        editar() {
            ...
            axios
                .put("/api/asignaringresos/editar_nuevo/", {
                    idtipoie: this.idtipoie,
                    contenidopr: this.contenidopr,
                    fecha_asignar:this.fecha_asignar,
                    id_empresa:this.usuario.id_empresa,
        ...
        listarAsignarIngreso(){
            if(this.$route.params.id){
                axios.get("/api/asignarinregos/ver_nuevo/"+this.$route.params.id)
                    .then(({ data }) =>{
                        this.contenidopr=data.recupera;
                        this.iddepart=data.recupera[0].id_departamento;
                        this.departamento=data.recupera[0].dep_nombre;
                        this.ingreso_egreso=data.cabecera[0].decripcion;
                        this.idtipoie=data.recupera[0].id_ingreso_egreso;
                        this.tipo3=data.cabecera[0].decripcion;
                        this.fecha_asignar=data.recupera[0].fecha_asignar;
                        var cabecera=data.cabecera;
                        cabecera.forEach(el=>{
                            this.array_ineg.push({
                                id_ineg:el.id_ingreso_egreso,
                                descripcion:el.decripcion
                            });
                        });
